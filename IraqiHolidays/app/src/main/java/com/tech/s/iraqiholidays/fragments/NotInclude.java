...
public class NotInclude extends Fragment {
    ...
    public NotInclude(String pid, String pImage) {
        id = pid;
        image = pImage;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_not_include, container, false);
    }
        ...
        call.enqueue(new Callback<PackInfo>() {
            ...
            public void onResponse(@NonNull Call<PackInfo> call, @NonNull Response<PackInfo> response) {
                if (response.isSuccessful() && response.body() != null) {
                    pText.setText(Html.fromHtml(response.body().getNotInclude()));
                }
            }
